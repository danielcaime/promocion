...
namespace promociones.api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //config
            services.Configure<PromotionConfiguration>(Configuration.GetSection("DatabaseConfiguration"));
            //DI services
